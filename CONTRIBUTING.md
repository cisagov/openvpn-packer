...
issue](https://github.com/cisagov/openvpn-packer/issues) in this
...
request](https://github.com/cisagov/openvpn-packer/pulls), you will
...
```bash
cd openvpn-packer
pyenv virtualenv <python_version_to_use> openvpn-packer
pyenv local openvpn-packer
